...
{ CardCartPrice, CardCartTitle, CardContainer, 
  ...
  ImageCardCart, ExitButton, ExitQuantityContainer, ButtonPlus, ButtonLess, ButtonQuantity,Quantity } from './CardProductChStyles'
import { useDispatch } from 'react-redux'
import { ButtonPlusF, ButtonLessF, RemoveProduct } from '../../redux/cart/CartSlice'



export const CardProductCheckout = ({img, price, title, id, key, quantity}) => {
